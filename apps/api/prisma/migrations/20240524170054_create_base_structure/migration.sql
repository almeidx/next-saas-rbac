-- CreateEnum
CREATE TYPE "token_types_enum" AS ENUM ('PasswordRecover');

-- CreateEnum
CREATE TYPE "account_providers_enum" AS ENUM ('GitHub');
...
CREATE TABLE "tokens" (
    "id" TEXT NOT NULL,
    "type" "token_types_enum" NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "accounts" (
    "id" TEXT NOT NULL,
    "provider" "account_providers_enum" NOT NULL,
...
CREATE TABLE "members" (
    "id" TEXT NOT NULL,
    "role" "roles_enum" NOT NULL DEFAULT 'Member',
    "organization_id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
